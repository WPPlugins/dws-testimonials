...
Author URI: jigzyy@gmail.com
Copyright 2014 Saad Siddique (email : jigzyy@gmail.com)
...
$dwsTestimonials = new _DWS_Post_Type($pluginName, 'Testimonial', 'Testimonials', plugins_url( 'images/testimonial.png' , __FILE__ ), 'testimonial', 'page', 31, array('title','editor','thumbnail'));
